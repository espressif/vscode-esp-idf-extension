...
export const defaultBoards = [
  ...
  } as IdfBoard,
  {
    ...
    target: "esp32",
    configFiles: ["board/esp32-bridge.cfg"],
  } as IdfBoard,
  {
    name: "ESP32-SOLO-1 module (via ESP-PROG)",
    description: "ESP32-SOLO-1 debugging via ESP-PROG board",
    target: "esp32",
    configFiles: ["interface/ftdi/esp_ftdi.cfg", "target/esp32-solo-1.cfg"],
  } as IdfBoard,
  {
  ...
  } as IdfBoard,
  {
    ...
    target: "esp32s2",
    configFiles: ["interface/ftdi/esp_ftdi.cfg", "target/esp32s2.cfg"],
  } as IdfBoard,
  {
