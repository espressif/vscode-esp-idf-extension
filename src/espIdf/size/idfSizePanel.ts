...
export class IDFSizePanel {
    ...
    public static createOrShow(context: vscode.ExtensionContext, webviewData?: object) {
    ...
    public static isCreatedAndHidden(): boolean {
        return IDFSizePanel.currentPanel && IDFSizePanel.currentPanel._panel.visible === false;
    }
    ...
    private constructor(panel: vscode.WebviewPanel, extensionPath: string, webviewData: object) {
        this._panel = panel;
