...
export function formatRedText(htmlString: string) {
...
export function formatLinkText(htmlString: string) {
...
export function formatBulletPoint(htmlString: string) {
...
export function formatEndBulletPoint(htmlString: string) {
...
export function formatNewLine(htmlString: string) {
  if (htmlString) {
...
export function formatHelpText(helpString: string) {
