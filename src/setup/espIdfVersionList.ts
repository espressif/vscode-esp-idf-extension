...
export async function downloadEspIdfVersionList(
  ...
  try {
    ...
    Logger.info(downloadMessage.statusMessage, { tags: [fileTag] });
    ...
    Logger.errorNotify(errorMsg, error, [fileTag]);
    try {
      ...
      Logger.errorNotify(fallBackErrMsg, fallbackError, [fileTag]);
    }
  }
}
