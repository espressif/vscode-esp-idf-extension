...
const flashChannel = "Flash";

/** Call-site overrides for OpenOCD errors during JTAG flash. */
export const flashJtagOpenOcdPresentation: ConnectOpenOcdForJtagPresentation = {
  notRunning: {
    userMessage:
