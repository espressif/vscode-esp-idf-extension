...
export const actions: ActionTree<IState, any> = {
    ...
    openExample(context, payload) {
        vscode.postMessage({ command: "openExampleProject", project_path: payload.pathToOpen, name: payload.name });
    },
    getExampleDetail(context, payload) {
        vscode.postMessage({ command: "getExampleDetail", path : payload.pathToOpen});
    },
};
