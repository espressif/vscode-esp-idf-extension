...
import { IEspIdfLink, IEspIdfStatus, IState, IToolStatus, IToolVersionResult } from "./types";
...
export const mutations: MutationTree<IState> = {
    ...
    updatePkgDownloadPercentage(state, pkgUpdatePercentage: IToolStatus) {
        const newState = state;
        newState.requiredToolsVersions = state.requiredToolsVersions.map((pkgInfo) => {
          ...
          return pkgInfo.id === pkgUpdatePercentage.id ? newPkgPercentage : pkgInfo;
        });
        Object.assign(state, newState);
    },
