 ...
 */
export async function showErrorNotificationWithLink(errorMessage, linkUrl, buttonLabel = "Read documentation") {
  const selectedOption = await vscode.window.showErrorMessage(errorMessage, buttonLabel);
