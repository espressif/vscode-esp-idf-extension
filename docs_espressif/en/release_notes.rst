...
- `EIM integration and removal of extension settings such as idf.espIdfPath and idf.toolsPath in favor of environment variables saved as extension global store state <https://github.com/espressif/vscode-esp-idf-extension/pull/1704>`_
